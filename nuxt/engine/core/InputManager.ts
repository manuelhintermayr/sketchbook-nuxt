...
export class InputManager implements IUpdatable
{
	...
	constructor(world: World, domElement: HTMLElement)
	{
		...
		// Cleanup: drop every listener we just attached when the host
		// World is torn down (HMR, route change). domElement-bound
		// listeners die with the canvas, but we still call removeListener
		// so the browser releases the closure references on contained
		// World references early.
