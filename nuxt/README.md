<p align="center">
	<a href="https://projects.manuelhintermayr.com/sketchbook-nuxt/"><img src="../src/img/thumbnail.png"></a>
	<br>
...
>
> The timeline of upstream merges (Inthenew / socketControl / Notblox / Joycon / cjmott / swift502) is in the [parent repository's README](../README.md) and is not duplicated here.
...
Everything happens inside the `nuxt/` directory.
...
├── public/                           ← copied assets (vehicles + maps live in ../build/assets,
│                                        served via Vite's @fs allow-list)
├── nuxt.config.ts
├── package.json
└── tsconfig.json
```
...
The engine and gameplay are 100 % the upstream Webpack edition's work — see the [parent repository's credits](../README.md#credits) for the full attribution chain. The Nuxt port is one author's reshaping of the shell layer:
